export default {
  section: [
    {
      header: "Descripción de la asignación de prueba (original)",
      p1: "La tarea es implementar una aplicación web sencilla que permita gestionar las solicitudes enviadas al soporte. La funcionalidad del sistema simplificado sería la siguiente.",
      list1: [
        "El usuario puede entrar una solicitud.",
        "La solicitud debe contener una descripción, hora de creación, la hora límite para la resolución; la hora de creación debe ser fechada por el sistema, los demás campos obligatorios son rellenados por el usuario.",
        ...
        "Las solicitudes que están a menos de 1 hora de plazo o que ya hayan vencido aparecerán en rojo en la lista.",
    ...
    {
      header: "Funcionalidades añadidas",
