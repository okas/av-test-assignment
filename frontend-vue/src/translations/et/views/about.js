export default {
  section: [
    ...
    {
      header: "Lisanduv funktsionaalsus",
      p1: "Otsistasin seda projekti edasi arendada, et eksperimenteerida ASP.NET Core Web API, VueJS ja teiste seotud tehnoloogiatega.",
